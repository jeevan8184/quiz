...
export const generateQuizText = async (req, res) => {
  try {
    const { text, questionCount, questionTypes, subject, difficulty } =
      req.body;
    ...
    console.error("Error in /api/generate-quiz/text:", error.message);
